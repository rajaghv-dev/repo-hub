...
| Handle | Label | Focus |
|---|---|---|
| `LineageOS` | LineageOS | LineageOS Android fork |
| `GrapheneOS` | GrapheneOS | Hardened Android OS |
| `postmarketOS` | postmarketOS | Linux-based mobile OS (Alpine base) |
| `ubports` | UBports | Ubuntu Touch |
| `openstf` | OpenSTF | STF — Smartphone Test Farm |
